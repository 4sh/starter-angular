...
const meta: Meta<UiSkeleton> = {
  ...
  argTypes: {
    shape: {
      ...
      description: 'Placeholder shape (associated default dimensions).',
      table: { type: { summary: 'UiSkeletonShape' }, defaultValue: { summary: '"text"' } },
    },
    size: {
      control: { type: 'inline-radio' },
      options: ['default', 'small'],
      description: 'Size preset (default dimensions based on the shape).',
      table: { type: { summary: 'UiSkeletonSize' }, defaultValue: { summary: '"default"' } },
    },
    width: {
      control: { type: 'text' },
      description: 'Raw CSS width, overrides the shape\'s default (e.g. `100%`, `10rem`).',
      table: { type: { summary: 'string' }, defaultValue: { summary: 'undefined' } },
    },
    height: {
      control: { type: 'text' },
      description: 'Raw CSS height, overrides the shape\'s default (e.g. `1rem`, `50px`).',
      table: { type: { summary: 'string' }, defaultValue: { summary: 'undefined' } },
    },
    borderRadius: {
      control: { type: 'text' },
      description: 'Raw CSS radius, overrides the shape\'s default.',
      table: { type: { summary: 'string' }, defaultValue: { summary: 'undefined' } },
    },
    animation: {
      control: { type: 'inline-radio' },
      options: ['wave', 'pulse', 'none'],
      description: "Loading animation style (`wave` = sliding shine, default).",
