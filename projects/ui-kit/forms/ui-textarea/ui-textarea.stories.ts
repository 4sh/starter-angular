...
const meta: Meta<UiTextarea> = {
  ...
  argTypes: {
    ...
    rows: {
      ...
      description: 'Nombre de lignes visibles initial.',
      table: { type: { summary: 'number' }, defaultValue: { summary: '3' } },
    },
    maxlength: {
      control: 'number',
      description: 'Nombre maximum de caractères (natif + borne du compteur).',
      table: { type: { summary: 'number' } },
    },
    autoResize: {
      control: 'boolean',
      description: 'La hauteur suit le contenu (désactive la poignée).',
      table: { type: { summary: 'boolean' }, defaultValue: { summary: 'false' } },
    },
    resize: {
      control: 'inline-radio',
      options: ['none', 'vertical', 'horizontal', 'both'],
      description: 'Axe de redimensionnement manuel.',
      table: { type: { summary: 'TextareaResize' }, defaultValue: { summary: "'vertical'" } },
    },
    showCount: {
      control: 'boolean',
...
export const Default: Story = {
  render: story(),
  args: { label: 'Message', placeholder: 'Votre message…' },
};
export const WithValue: Story = {
  render: story('Bonjour,\nvoici un message multiligne.'),
  args: { label: 'Message' },
};
export const WithHelper: Story = {
  ...
  args: {
    ...
    helperText: 'Restez courtois et concis.',
  },
};
export const Success: Story = {
  render: story('Contenu validé'),
...
export const AutoResize: Story = {
  render: story('Cette zone grandit automatiquement\nà mesure que vous écrivez.'),
  args: { label: 'Auto-resize', autoResize: true },
};
export const ResizeBoth: Story = {
  render: story('Poignée sur les deux axes.'),
  args: { label: 'Resize libre', resize: 'both' },
};
export const Disabled: Story = {
  render: story('Non modifiable'),
  args: { label: 'Message', disabled: true },
};
export const Readonly: Story = {
  render: story('Lecture seule'),
  args: { label: 'Message', readonly: true },
};
