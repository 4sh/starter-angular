...
const meta: Meta<UiTextarea> = {
  ...
  argTypes: {
    ...
    rows: { control: { type: 'number', min: 1 }, description: 'Initial number of visible rows.', table: { type: { summary: 'number' }, defaultValue: { summary: '3' } } },
    maxlength: { control: 'number', description: 'Maximum number of characters (native + counter bound).', table: { type: { summary: 'number' } } },
    autoResize: { control: 'boolean', description: 'Height follows the content (disables the resize handle).', table: { type: { summary: 'boolean' }, defaultValue: { summary: 'false' } } },
    ...
    showCount: { control: 'boolean', description: 'Shows a character counter.', table: { type: { summary: 'boolean' }, defaultValue: { summary: 'false' } } },
