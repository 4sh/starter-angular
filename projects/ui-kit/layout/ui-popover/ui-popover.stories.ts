...
const meta: Meta<UiPopover> = {
  ...
  argTypes: {
    dismissable: {
      ...
      description: 'Closes the panel on an outside click (and outside the trigger).',
      table: { type: { summary: 'boolean' }, defaultValue: { summary: 'true' } },
    },
    position: {
      control: { type: 'select' },
      options: ['top', 'bottom', 'left', 'right'],
      description: 'Preferred side of the trigger; flips automatically if there\'s no room.',
      table: { type: { summary: "'top' | 'bottom' | 'left' | 'right'" }, defaultValue: { summary: "'bottom'" } },
    },
    showArrow: {
      control: { type: 'boolean' },
      description: 'Shows the arrow pointing to the trigger.',
      table: { type: { summary: 'boolean' }, defaultValue: { summary: 'true' } },
    },
    modal: {
      control: { type: 'boolean' },
      description: 'Makes the panel modal: `aria-modal` and a permanent focus trap.',
      table: { type: { summary: 'boolean' }, defaultValue: { summary: 'false' } },
    },
    role: {
      control: { type: 'text' },
      description: 'ARIA role of the panel.',
      table: { type: { summary: 'string' }, defaultValue: { summary: "'dialog'" } },
    },
    ariaLabel: {
      control: { type: 'text' },
      description: 'Accessible name of the panel (recommended).',
      table: { type: { summary: 'string' }, defaultValue: { summary: 'undefined' } },
    },
    ariaLabelledBy: {
      control: { type: 'text' },
      description: "id of an external element naming the panel.",
      table: { type: { summary: 'string' }, defaultValue: { summary: 'undefined' } },
    },
    focusOnShow: {
      control: { type: 'boolean' },
      description: "Moves focus into the panel on open (first focusable or `[autofocus]`).",
      table: { type: { summary: 'boolean' }, defaultValue: { summary: 'true' } },
    },
    closeOnEscape: {
      control: { type: 'boolean' },
      description: 'Closes the panel on the Escape key (focus returns to the trigger).',
      table: { type: { summary: 'boolean' }, defaultValue: { summary: 'true' } },
    },
    motion: {
      control: { type: 'boolean' },
      description: "Animates the panel's entrance (reduced-motion / `data-motion=off` take priority).",
      table: { type: { summary: 'boolean' }, defaultValue: { summary: 'true' } },
    },
    styleClass: {
      control: { type: 'text' },
      description: 'Additional class(es) applied to the panel.',
      table: { type: { summary: 'string' }, defaultValue: { summary: 'undefined' } },
    },
