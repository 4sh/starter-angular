...
const ALL_ORDERS: Order[] = [
  {
    ...
    status: 'delivered',
    items: [
      { label: 'T-shirt premium', qty: 2, unitPrice: 49.95 },
      { label: 'Ceinture cuir', qty: 1, unitPrice: 90 },
    ],
  },
  {
    id: '2',
    ...
    status: 'shipped',
    items: [
      { label: 'Casquette', qty: 1, unitPrice: 34.5 },
      { label: 'Chaussettes (lot)', qty: 2, unitPrice: 20 },
    ],
  },
  {
    id: '3',
  ...
  },
  {
    ...
    status: 'cancelled',
    items: [
      { label: 'Sneakers blanc', qty: 1, unitPrice: 119.9 },
      { label: 'Polo slim', qty: 2, unitPrice: 49.95 },
    ],
  },
  {
    id: '6',
    ...
    amount: 98.5,
    status: 'shipped',
    items: [{ label: 'Jeans coupe droite', qty: 1, unitPrice: 98.5 }],
  },
  {
    id: '7',
    number: 'CMD-2025-007',
  ...
  },
  {
    ...
    status: 'delivered',
    items: [
      { label: 'Gants hiver', qty: 2, unitPrice: 22.95 },
      { label: 'Bonnet', qty: 1, unitPrice: 22 },
    ],
  },
  {
    id: '10',
    ...
    amount: 149.9,
    status: 'pending',
    items: [{ label: 'Blouson cuir', qty: 1, unitPrice: 149.9 }],
  },
];
...
export class DemoOrders {
  ...
  readonly orders = computed(() => {
    ...
    return ALL_ORDERS.filter((o) => {
      const matchQ =
        !q || o.number.toLowerCase().includes(q) || o.customer.name.toLowerCase().includes(q);
  ...
  statusLevel(status: OrderStatus): UiFeedbackLevel {
    return STATUS_CONFIG[status].level;
  }
