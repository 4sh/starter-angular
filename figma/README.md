...
component variable belongs to one component, and 540 of the 677 entries merely _alias_ a
...
- `$extensions.com.4sh.ui-kit.skipped` lists 57 entries with nothing to create: `calc()`
