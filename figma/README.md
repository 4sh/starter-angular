...
component variable belongs to one component, and 1243 of the 1395 entries merely _alias_ a
...
- `$extensions.com.4sh.ui-kit.skipped` lists 62 entries with nothing to create: `calc()`
