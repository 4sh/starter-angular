...
component variable belongs to one component, and 526 of the 653 entries merely _alias_ a
...
- `$extensions.com.4sh.ui-kit.skipped` lists 55 entries with nothing to create: `calc()`
