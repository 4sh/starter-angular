...
> **For a kit developer feeding the Figma file.** You need `npm run docs:config` to
> regenerate the JSON, and write access to the file that *owns* the variable collections
...
component variable belongs to one component, and 455 of the 575 entries merely *alias* a
