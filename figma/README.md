...
component variable belongs to one component, and 504 of the 630 entries merely _alias_ a
...
- `$extensions.com.4sh.ui-kit.skipped` lists 48 entries with nothing to create: `calc()`
